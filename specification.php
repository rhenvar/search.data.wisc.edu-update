...
class Specification {
    function __construct($specification_id, $specification_name, $specification_type, $description, $functional_areas, $attribute_4_name, $attribute_4_value, $last_revised, $ratio = null, $attribute_7_name = 'public', $attribute_7_value = null, $attribute_8_name = 'Request URL', $attribute_8_value = null, $additional_details = "") {
