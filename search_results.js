(function() {
    ...
    function search() {
        ...
        var type = (typeElements[0].checked ? typeElements[0].value : typeElements[1].value);
    ...
    function processResponse() {
        ...
        if (200 == this.status) {
            ...
            // if searched for reports
            if (this.responseText == "No Databases Found") {
                noResults();
                return;
            }

            if ('dashboardsReports' == type) {
                showReports(this);
            }
            else if ('dataDefinitions' == type) {
