...
<div class="search_container">
    <div id="bar_container">
        ...
        <div id ="radio_container">
            <label class="block"><input type="radio" name="type" value="dashboardsReports" class="radio_button" checked="checked">Dashboards/Reports</input></label>
            <label class="block"><input type="radio" name="type" value="dataDefinitions" class="radio_button">Data Definitions</input></label>
        </div>
